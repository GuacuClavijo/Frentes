...
/* V25 interaction/layout helpers */
(function(){
  function enableV25(){
    ...
    if(axis){
      ...
      axis.addEventListener('wheel',function(e){
        e.preventDefault();
        if(typeof zoomAt==='function') zoomAt(e.clientX,e.deltaY<0?1.22:1/1.22);
      },{passive:false});
    }
  }
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',enableV25);else enableV25();
})();
